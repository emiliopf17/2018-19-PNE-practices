...
print("Bases count: A" + str(s1.count("A"))+ ",T:"+str(s1.count("T"))+",C:"+str(s1.count("C"))+",G:"+str(s1.count("A")))
...
print("Bases count: A" + str(s2.count("A"))+ ",T:"+str(s2.count("T"))+",C:"+str(s2.count("C"))+",G:"+str(s2.count("A")))
...
print("Bases count: A" + str(s3.count("A"))+ ",T:"+str(s3.count("T"))+",C:"+str(s3.count("C"))+",G:"+str(s3.count("A")))
...
print("Bases count: A" + str(s4.count("A"))+ ",T:"+str(s4.count("T"))+",C:"+str(s4.count("C"))+",G:"+str(s4.count("A")))
